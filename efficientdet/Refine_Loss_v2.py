...
def visualize_Rectangle_area(image_path, lists):
    ...
    cv2.imwrite('/home/fzh/Rotation-EfficinetDet/visualize_Rectangle_area.jpg',
                image)
...
def visualize_poly2Horizontal_rect(image_path, lists):
    ...
    cv2.imwrite('/home/fzh/Rotation-EfficinetDet/visualize_visualize_poly2Horizontal_rect.jpg',
                img)
...
def visualize_positive_anchor(image_path, anchor_lists, index_lists):
    ...
    cv2.imwrite('/home/fzh/Rotation-EfficinetDet/visualize_positive_anchor.jpg',
                image)
...
def visualize_rp_anchor(path, lists):
    ...
    cv2.imwrite('/home/fzh/Rotation-EfficinetDet/visualize_rp_anchor.jpg', image)
...
def check_anchor(path, lists):
    ...
    cv2.imwrite('/home/fzh/Rotation-EfficinetDet/check_anchor.jpg', image)
...
def visualize_pp_anchor(path, lists):
    ...
    cv2.imwrite('/home/fzh/Rotation-EfficinetDet/visualize_pp_anchor.jpg', image)
...
class FocalLoss(nn.Module):
    ...
    def forward(self, classifications, regressions, anchors, annotations, **kwargs):
        ...
        for j in range(batch_size):
            ...
            # image_path = r'/home/fzh/Rotation-EfficinetDet/datasets/temp_dataset/train/P0189_174_359_1114.jpg'
...
if __name__ == '__main__':
    ...
    yamlpath = os.path.join(yaml_rootpath, 'temp_dataset.yml')
