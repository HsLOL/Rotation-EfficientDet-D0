...
class FocalLoss(nn.Module):
    ...
    def forward(self, classifications, regressions, anchors, annotations, **kwargs):
        ...
        for j in range(batch_size):
            ...
            hor_positive_indices = torch.ge(hor_IoU_max, 0.2)
            ...
            rotation_threshold = 0.4  # 使用0.2的阈值可以有较高的检测正类个数
            ...
            if rotation_positive_indices.sum() > 0:
                ...
                for ind in range(len(rotation_anchor_theta)):
                    ...
                    targets_dx = (rotation_assigned_annotations_gt[ind][0] - rotation_anchor_ctr_x_pi[ind]) / rotation_anchor_widths_pi[ind]
                    targets_dy = (rotation_assigned_annotations_gt[ind][1] - rotation_anchor_ctr_y_pi[ind]) / rotation_anchor_heights_pi[ind]
                    ...
                    targets_theta = (rotation_assigned_annotations_gt[ind][4] / 180 * math.pi) - ((rotation_anchor_theta[ind] / 180) * math.pi)
