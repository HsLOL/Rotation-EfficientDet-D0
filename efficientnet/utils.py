...
def efficientnet_params(model_name):
    ...
    params_dict = {
        ...
        # Coefficients:   channel, depth(the num of the block), resolution, dropout
...
def efficientnet(width_coefficient=None, depth_coefficient=None, dropout_rate=0.2,
    ...
    """
    r = num_repeat, k = kernel_size, s = stride(1, 1), e = expand_ratio,
    i = input_filters, o = output_filters, se = se_ratio
    """
    blocks_args = [
