...
#
#
# 批量检测图片(用于生成评估文件，仅适是适用于len(ratios) * len(scales) = 9的情况
# 运行方式：
# Step 1:
...
# 模型读取旋转框权重文件
model.load_state_dict(torch.load(f'/home/fzh/Rotation-EfficinetDet/logs/rotation_vehicles/efficientdet-d0_15_2100.pth',
                                 map_location='cpu'))
