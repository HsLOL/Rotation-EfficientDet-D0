...
if __name__ == '__main__':
    # val set json file
    json_path = r'../datasets/rotation_vehicles/annotations/instances_val.json'
    image_lists = load_json(json_path)

    # images will be inferenced

    imgnamefile_path = r'imgnamefile.txt'
    if os.path.exists(imgnamefile_path):
        print(f'{imgnamefile_path} has existed.')
    else:
