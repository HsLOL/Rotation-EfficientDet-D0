...
from efficientdet.rotation_dataset import RotationCocoDataset, Resizer, Normalizer, collater
...
def get_args():
    parser = argparse.ArgumentParser('A rotation detector based EfficientDet, which is modified by HsLoL.')
    parser.add_argument('-p', '--project', type=str, default='rotation_vehicles',
    ...
    parser.add_argument('--val_batch_size', type=int, default=32, help='the number of images per batch for val')
